...
const QuickSale = lazyWithRetry(() => import('./components/QuickSale'))
const CashRegister = lazyWithRetry(() => import('./components/CashRegister'))
const Appointment = lazyWithRetry(() => import('./components/Appointment'))
const CustomerList = lazyWithRetry(() => import('./components/CustomerList'))
const LeadManagement = lazyWithRetry(() => import('./components/LeadManagement'))
const MissedEnquiries = lazyWithRetry(() => import('./components/MissedEnquiries'))
const CustomerLifecycleReport = lazyWithRetry(() => import('./components/CustomerLifecycleReport'))
const Feedback = lazyWithRetry(() => import('./components/Feedback'))
const ServiceRecovery = lazyWithRetry(() => import('./components/ServiceRecovery'))
const DiscountApprovals = lazyWithRetry(() => import('./components/DiscountApprovals'))
const ApprovalCodes = lazyWithRetry(() => import('./components/ApprovalCodes'))
const OfferCampaigns = lazyWithRetry(() => import('./components/OfferCampaigns'))
const OfferManagement = lazyWithRetry(() => import('./components/OfferManagement'))
const Inventory = lazyWithRetry(() => import('./components/Inventory'))
const ReportsAnalytics = lazyWithRetry(() => import('./components/ReportsAnalytics'))
const Service = lazyWithRetry(() => import('./components/Service'))
const Package = lazyWithRetry(() => import('./components/Package'))
const Product = lazyWithRetry(() => import('./components/Product'))
const Settings = lazyWithRetry(() => import('./components/Settings'))
const Membership = lazyWithRetry(() => import('./components/Membership'))
const ReferralProgram = lazyWithRetry(() => import('./components/ReferralProgram'))
const Tax = lazyWithRetry(() => import('./components/Tax'))
const Manager = lazyWithRetry(() => import('./components/Manager'))
const OwnerSettings = lazyWithRetry(() => import('./components/OwnerSettings'))
const Staffs = lazyWithRetry(() => import('./components/Staffs'))
const StaffAttendance = lazyWithRetry(() => import('./components/StaffAttendance'))
const AssetManagement = lazyWithRetry(() => import('./components/AssetManagement'))
const Expense = lazyWithRetry(() => import('./components/Expense'))
const ServiceSalesAnalysis = lazyWithRetry(() => import('./components/ServiceSalesAnalysis'))
const BillHistory = lazyWithRetry(() => import('./components/BillHistory'))
const ListOfBills = lazyWithRetry(() => import('./components/ListOfBills'))
const ListOfDeletedBills = lazyWithRetry(() => import('./components/ListOfDeletedBills'))
const SalesByServiceGroup = lazyWithRetry(() => import('./components/SalesByServiceGroup'))
const MembershipClients = lazyWithRetry(() => import('./components/MembershipClients'))
const StaffIncentiveReport = lazyWithRetry(() => import('./components/StaffIncentiveReport'))
const ExpenseReport = lazyWithRetry(() => import('./components/ExpenseReport'))
const InventoryReport = lazyWithRetry(() => import('./components/InventoryReport'))
const StaffCombinedReport = lazyWithRetry(() => import('./components/StaffCombinedReport'))
const BusinessGrowthTrendAnalysis = lazyWithRetry(() => import('./components/BusinessGrowthTrendAnalysis'))
const StaffPerformanceAnalysis = lazyWithRetry(() => import('./components/StaffPerformanceAnalysis'))
const PeriodPerformanceSummary = lazyWithRetry(() => import('./components/PeriodPerformanceSummary'))
const ClientValueLoyaltyReport = lazyWithRetry(() => import('./components/ClientValueLoyaltyReport'))
const ServiceProductPerformance = lazyWithRetry(() => import('./components/ServiceProductPerformance'))
